...
<body id="RegBack" style="background-image:url('images/iii.jpg'); background-size:cover;">   
     ...
     <div  class="main">
      <div class="one">
        <div class="register">
            ...
            <h1 style="color:white;text-align:center"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; My Profile Form</h1>
...
<ajaxToolkit:CalendarExtender ID="Calendar1" PopupButtonID="imgPopup" runat="server" TargetControlID="txtdob" Format="dd/MM/yyyy">
                ...
                <tr>
                     <td>
                        <asp:Button ID="btnUpdate" runat="server" Text="Update" OnClick="btnUpdate_Click" BackColor="#66CCFF" Height="32px" Width="100px" /></td>
                    <td class="auto-style1">
                        <asp:Button ID="btnClear" runat="server" Text="Cancel" BackColor="#66CCFF"  CausesValidation="False" PostBackUrl="~/WelcomeUser.aspx" ValidateRequestMode="Disabled" Height="32px" Width="100px" />
